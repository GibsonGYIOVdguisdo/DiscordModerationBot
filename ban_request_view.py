...
class BanRequestView(StaffVoteView):
    ...
    def __init__(self, executor: discord.Member, punished_member: discord.Member, reason: str, evidence: str, helper_utils: HelperUtils, request_message:discord.Message=None):
